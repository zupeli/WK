...
uses
  ...
  public
    ...
    procedure getTotalizadorCliente(pIdCliente: integer; var rQtd: integer;
...
procedure TCLiente.getTotalizadorCliente(pIdCliente : integer; var rQtd : integer; var rValTotal, rValUnit : Extended);
var
  vOjbDM : TDM;
begin
  vOjbDM := TDM.Create(nil);
  try
    vOjbDM.TotalizadorCliente(pIdCliente, rQtd, rValTotal, rValUnit);
  finally
    FreeAndNil(vOjbDM);
  end;
